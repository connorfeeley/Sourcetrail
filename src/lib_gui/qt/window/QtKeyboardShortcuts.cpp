...
void QtKeyboardShortcuts::populateWindow(QWidget* widget) {
  ...
  widget->setStyleSheet(
      utility::getStyleSheet(ResourcePaths::getGuiDirectoryPath().concatenate(L"keyboard_shortcuts/keyboard_shortcuts.css")).c_str());
}
  ...
  addShortcuts(
      ...
      {Shortcut(QStringLiteral("Switch Focus between Graph and Code"), QStringLiteral("Tab")),
       ...
       Shortcut::defaultOrMac(
           QStringLiteral("Back"), QStringLiteral("Alt + Left | Z | Y | Backspace"), QStringLiteral("Cmd + [ | Z | Y | Backspace")),
       ...
       Shortcut::winMacOrLinux(
           QStringLiteral("Close Window"), QStringLiteral("Alt + F4"), QStringLiteral("Cmd + W"), QStringLiteral("Ctrl + W")),
...
QTableWidget* QtKeyboardShortcuts::createCodeViewShortcutsTable() {
  ...
  addShortcuts(
      ...
      {Shortcut(QStringLiteral("Move Focus Within Code"), QStringLiteral("WASD | HJKL | Arrows")),
       Shortcut(QStringLiteral("Move Focus to Closest Reference"), QStringLiteral("Shift + WASD | Shift + HJKL | Shift + Arrows")),
       ...
       Shortcut::defaultOrMac(
           QStringLiteral("Previous Reference"), QStringLiteral("Ctrl + Shift + G"), QStringLiteral("Cmd + Shift + G")),
       Shortcut::defaultOrMac(QStringLiteral("Next Local Reference"), QStringLiteral("Ctrl + L"), QStringLiteral("Cmd + L")),
       Shortcut::defaultOrMac(
           QStringLiteral("Previous Local Reference"), QStringLiteral("Ctrl + Shift + L"), QStringLiteral("Cmd + Shift + L")),
       Shortcut::defaultOrMac(QStringLiteral("Scroll Code Area"), QStringLiteral("Ctrl + Arrows"), QStringLiteral("Cmd + Arrows"))});
  ...
  addShortcuts(
      ...
      {Shortcut(QStringLiteral("Move Focus Within Nodes"), QStringLiteral("WASD | HJKL | Arrows")),
       ...
       Shortcut::defaultOrMac(QStringLiteral("Activate Node in New Tab"),
                              QStringLiteral("Ctrl + Shift + Enter | Ctrl + Shift + E"),
                              QStringLiteral("Cmd + Shift + Enter | Cmd + Shift + E")),
       Shortcut::defaultOrMac(QStringLiteral("Scroll Graph Area"), QStringLiteral("Ctrl + Arrows"), QStringLiteral("Cmd + Arrows")),
